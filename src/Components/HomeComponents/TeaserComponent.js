        ...
        <div className="container">
          ...
          <div className="teaser-content">
            ...
            <div className="sub-teaser-content sub-teaser-2">
              <p className="teaser-p">
                Familienabend? Romantisches Date? Oder einfach nur gönnen? Mit
                McDelivery® liefern wir dir jetzt für jeden Anlass das passende
                Menü oder Bundle. Schnell, einfach und lecker. Jetzt bei
                Lieferando bestellen und genießen!
              </p>
              <div className="teaser-btn-div">
          ...
          <div className="teaser-content">
            ...
            <div className="sub-teaser-content sub-teaser-3">
              <p className="teaser-p">
                ...
                gemeinsam richtig entsorgen und in die Kreisläufe zurückbringen.
                Erfahre hier alles über unseren Plan für weniger Müll und
                Plastik!
              </p>
              <div className="teaser-btn-div">
